      ...
      <div className="container-fluid container-xl d-flex align-items-center justify-content-lg-between">
        ...
        <nav id="navbar" className="navbar order-last order-lg-0">
          <ul>
            ...
            <li><a className="nav-link scrollto active" href="/projects">Projects</a></li>
  ...
  >
    ...
    <DialogContent dividers style={{marginTop:10}}>
      <Typography gutterBottom>
       ...
       <center><a className="nav-link scrollto active" style={{fontWeight: 'bold',color:'black'}} onClick={handleClose} href="/projects">Projects</a></center>
    ...
    {/* End Header */}
            ...
            {/* ======= Hero Section ======= */}
            <section id="heroProjects" className="d-flex align-items-center">
          ...
          <div className="row menu-container" data-aos="fade-up" data-aos-delay={200}>
            <div className="col-lg-6 menu-item filter-starters">
              ...
              <div className="menu-content">
                <a target="_blabk" href="https://tuexchange.co.ke">Tu-Exchange</a><span>01/04/2021</span>
              </div>
              <div className="menu-ingredients">
              We provide a platform to exchange surplus solid items for what you are in need of. By this, we help you optimize the value of your products without accruing further costs. Exchange with us for efficiency.
                </div>
            </div>
          </div>
        </div>
